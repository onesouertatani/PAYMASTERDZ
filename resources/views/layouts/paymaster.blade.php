...
<html lang="EN">
                ...
                <div>
                    <a class="logo" href="{{ url('/') }}">
                        <span class="logo-light-mode">
                            ...
                            <img src="images/logo-light1.png" class="l-light"  alt="">
                        </span>
                        <img src="images/logo-light1.png"  class="logo-dark-mode" alt="">
                    </a>
                </div>    
    ...
    $(".changeLang").change(function(){
        ...
        <script src="layouts/js/jquery-3.2.0.min.js"></script>
